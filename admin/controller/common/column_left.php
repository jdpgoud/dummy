...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/topic')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_topic'),
					'href'     => $this->url->link('catalog/topic', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/testquestion')) {		
				$catalog[] = array(
					'name'	   => $this->language->get('text_testquestion'),
					'href'     => $this->url->link('catalog/testquestion', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);		
			}
